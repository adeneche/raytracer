...
public class Constants {
	...
	public static final float 	PI_ON_180 	= 0.0174532925199432957f;
	public static final float 	invPI 		= 0.3183098861837906715f;
	public static final float 	invTWO_PI 	= 0.1591549430918953358f;

	public static final float 	kEpsilon 	= 0.0001f; 
	public static final float	kHugeValue	= 1.0E10f;
